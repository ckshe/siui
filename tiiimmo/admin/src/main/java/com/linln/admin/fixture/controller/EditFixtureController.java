...
import com.linln.admin.fixture.validator.EditFixtureValid;
 ...
 */
@Controller
@RequestMapping("/fixture/editFixture")
public class EditFixtureController {
    ...
    public String index(Model model, EditFixture editFixture) {
        ...
        return "/fixture/editFixture/index";
    }
    ...
    public String toAdd() {
        return "/fixture/editFixture/add";
    }
    ...
    public String toDetail(@PathVariable("id") EditFixture editFixture, Model model) {
        model.addAttribute("editFixture",editFixture);
        return "/fixture/editFixture/detail";
    }

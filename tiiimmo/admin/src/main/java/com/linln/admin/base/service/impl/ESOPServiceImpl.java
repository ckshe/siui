...
import com.linln.admin.base.repository.ESOPRepository;
...
public class ESOPServiceImpl implements ESOPService {
    ...
    @Override
    @Transactional
    public ESOP getById(Long id) {
        return esopRepository.findById(id).orElse(null);
    }
     ...
     */
    @Override
    public Page<ESOP> getPageList(Example<ESOP> example) {
        // 创建分页对象
        PageRequest page = PageSort.pageRequest();
        return esopRepository.findAll(example, page);
    }
     ...
     */
    @Override
    public ESOP save(ESOP esop) {
        return esopRepository.save(esop);
    }
    ...
    public Boolean updateStatus(StatusEnum statusEnum, List<Long> idList) {
        return esopRepository.updateStatus(statusEnum.getCode(), idList) > 0;
    }

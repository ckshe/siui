...
public interface ProcessTaskRepository extends BaseRepository<ProcessTask,Long> {
    ...
    @Query(value = "select * from produce_process_task where process_task_status = '生产中' ",nativeQuery = true)
    List<ProcessTask> findByProducing();

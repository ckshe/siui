package com.linln.admin.environmentRecordTime.controller;
...
import com.linln.admin.environmentRecordTime.validator.EnvironmentRecordTimeValid;
 ...
 */
@Controller
@RequestMapping("/environmentRecordTime/environmentRecordTime")
public class EnvironmentRecordTimeController {
    ...
    public String index(Model model, EnvironmentRecordTime environmentRecordTime) {
        ...
        return "/environmentRecordTime/environmentRecordTime/index";
    }
    ...
    public String toAdd() {
        return "/environmentRecordTime/environmentRecordTime/add";
    }
    ...
    public String toDetail(@PathVariable("id") EnvironmentRecordTime environmentRecordTime, Model model) {
        model.addAttribute("environmentRecordTime",environmentRecordTime);
        return "/environmentRecordTime/environmentRecordTime/detail";
    }
